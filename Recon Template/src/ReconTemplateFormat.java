...
public class ReconTemplateFormat extends JFrame {
	...
	public ReconTemplateFormat() {
		...
		gbc_chckbxParkonPlatform.gridy = 5;
		...
		gbc_chckbxAssistWithClimb.gridy = 7;
